...
/*    Frederic SCHUMACHER / Pierre SAMAT - 20/01/2015                            */
/*    ATMEL ROUSSET                                                              */
/* ============================================================================= */
...
typedef struct {
  ...
  __IO uint32_t SDMMC_SBCR;         /**< \brief (SDMMC Offset: 0x0E0) Shared Bus Control Register */
...
/* --------  SDMMC_CAR[1] (SDMMC Offset: 0x044) Capabilities Register */
...
#define SDMMC_ASAR_ADMASA_Pos 0
#define SDMMC_ASAR_ADMASA_Msk (0xFFFFFFFFu << SDMMC_ASAR_ADMASA_Pos)
...
/* --------  SDMMC_SBCR (SDMMC Offset: 0x0E0) Shared Bus Control Register */
#define SDMMC_SBCR_NBCLKP_Pos 0
#define SDMMC_SBCR_NBCLKP_Msk (0x7u << SDMMC_SBCR_NBCLKP_Pos)
#define SDMMC_SBCR_NBCLKP(value) ((SDMMC_SBCR_NBCLKP_Msk & ((value) << SDMMC_SBCR_NBCLKP_Pos)))
#define SDMMC_SBCR_NBINTP_Pos 4
#define SDMMC_SBCR_NBINTP_Msk (0x3u << SDMMC_SBCR_NBINTP_Pos)
#define SDMMC_SBCR_NBINTP(value) ((SDMMC_SBCR_NBINTP_Msk & ((value) << SDMMC_SBCR_NBINTP_Pos)))
#define SDMMC_SBCR_BWDTPRE_Pos 8
#define SDMMC_SBCR_BWDTPRE_Msk (0x7Fu << SDMMC_SBCR_BWDTPRE_Pos)
#define SDMMC_SBCR_BWDTPRE(value) ((SDMMC_SBCR_BWDTPRE_Msk & ((value) << SDMMC_SBCR_BWDTPRE_Pos)))
#define SDMMC_SBCR_CLKPSEL_Pos 16
#define SDMMC_SBCR_CLKPSEL_Msk (0x7u << SDMMC_SBCR_CLKPSEL_Pos)
#define SDMMC_SBCR_CLKPSEL(value) ((SDMMC_SBCR_CLKPSEL_Msk & ((value) << SDMMC_SBCR_CLKPSEL_Pos)))
#define SDMMC_SBCR_INTPSEL_Pos 20
#define SDMMC_SBCR_INTPSEL_Msk (0x7u << SDMMC_SBCR_INTPSEL_Pos)
#define SDMMC_SBCR_INTPSEL(value) ((SDMMC_SBCR_INTPSEL_Msk & ((value) << SDMMC_SBCR_INTPSEL_Pos)))
#define SDMMC_SBCR_BEPCTRL_Pos 24
#define SDMMC_SBCR_BEPCTRL_Msk (0x7Fu << SDMMC_SBCR_BEPCTRL_Pos)
#define SDMMC_SBCR_BEPCTRL(value) ((SDMMC_SBCR_BEPCTRL_Msk & ((value) << SDMMC_SBCR_BEPCTRL_Pos)))
...
//#define SDMMC_TUNSR_KO2OK(value) ((SDMMC_TUNSR_KO2OK_Msk & ((value) << SDMMC_TUNSR_KO2OK_Pos)))
//#define SDMMC_TUNSR_OK2KO_Pos 8
//#define SDMMC_TUNSR_OK2KO_Msk (0xFFu << SDMMC_TUNSR_OK2KO_Pos)
//#define SDMMC_TUNSR_OK2KO(value) ((SDMMC_TUNSR_OK2KO_Msk & ((value) << SDMMC_TUNSR_OK2KO_Pos)))
//#define SDMMC_TUNSR_HLFPER_Pos 16
//#define SDMMC_TUNSR_HLFPER_Msk (0xFFu << SDMMC_TUNSR_HLFPER_Pos)
//#define SDMMC_TUNSR_HLFPER(value) ((SDMMC_TUNSR_HLFPER_Msk & ((value) << SDMMC_TUNSR_HLFPER_Pos)))
//#define SDMMC_TUNSR_PERIOD_Pos 24
//#define SDMMC_TUNSR_PERIOD_Msk (0xFFu << SDMMC_TUNSR_PERIOD_Pos)
//#define SDMMC_TUNSR_PERIOD(value) ((SDMMC_TUNSR_PERIOD_Msk & ((value) << SDMMC_TUNSR_PERIOD_Pos)))
#define SDMMC_TUNSR_DLLPS_Pos 0
#define SDMMC_TUNSR_DLLPS_Msk (0xFu << SDMMC_TUNSR_DLLPS_Pos)
#define SDMMC_TUNSR_SMPLES (0x1u << 8)
