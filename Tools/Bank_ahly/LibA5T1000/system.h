...
System Pack V1.4
================
1. Add CFB mode support in os_key_des(). For DES, CFB8,16,32 & 64 will be supported while for SM4 & AES, CFB8,16,32,64 & 128 will be supported.
...
4. add K_ConnectSpeed2400Fast 2400bps fast connect in modem
5. modify os_get_version() to return binary version as well
...
enum system_call_list {
  ...
  OS_FN_WIFI_GET_REGULATORY_DOMAIN,          /* 466 */
  OS_FN_WIFI_SET_REGULATORY_DOMAIN,          /* 467 */  
  OS_FN_TAMPER_UNLOCK,                       /* 468 */
  OS_FN_BATT_LEVEL2,                         /* 469 */
  OS_FN_IMG_SENSOR_SET_MODE,                 /* 470 */
  OS_FN_GPS_GET_DETAIL_INFO,         /* 471 */
  END_OF_OS_FN_LIST
};

                /****** system func routine ******/

// DWORD os_get_version(BYTE * a_ptr);
...
#define K_DesModeMark             0xBC000000
#define K_DesModeShift            26
#define K_DesEcbMode              0x00000000
#define K_DesCbcMode              0x80000000
#define K_DesCfb8Mode             0x04000000     
#define K_DesCfb16Mode            0x08000000     
#define K_DesCfb32Mode            0x0C000000     
#define K_DesCfb64Mode            0x10000000     
#define K_DesCfb128Mode           0x14000000     
...
//         = 1 => decrypt
// a_len bit 29-26
//         = 0 => mode defined by bit 31
//         = 1 => CFB 8
//         = 2 => CFB 16
//         = 3 => CFB 32
//         = 4 => CFB 64
//         = 5 => CFB 128, valid for SM4 and AES only
// a_len bit25-0
...
enum {
  ...
  K_CF_TermIDControlOff,      // cf2, r/w,         1-byte (ECR-0117)
  K_CF_Max
};
...
#define K_LptVoltageStarting    345
// a_init_str
...
#define K_ConnectSpeed1200      1       // fast connect
#define K_ConnectSpeed2400      2       // normal connect
...
#define K_ConnectSpeed2400Fast  11      // fast connect
...
#define K_BattLow               0x20000000
#define K_BattPrintLow          0x10000000

// DWORD os_batt_level(void); //retrieve battery voltage with unit 0.1V
#define os_batt_level()         sys_func0(OS_FN_BATT_LEVEL)
// DWORD os_batt_level2(void);  //retrieve battery voltage with unit 0.01V
#define os_batt_level2()        sys_func0(OS_FN_BATT_LEVEL2)
...
// exit code
#define K_PowerSleepRtcReadError      -25
...
#define os_power_sleep_wto(x)           (int)sys_func2(OS_FN_POWER_SLEEP,1,x) // Poll On Key Only
#define os_power_sleep_nk_npwake_wto(x) (int)sys_func2(OS_FN_POWER_SLEEP,2,x) // Poll Power Only (Ext. Power Removal)
#define os_power_sleep_pwake_wto(x)     (int)sys_func2(OS_FN_POWER_SLEEP,3,x) // Poll On Key + Ext. Power plug-in (ECR17-0008)
#define os_power_sleep_ak_pwake_wto(x)  (int)sys_func2(OS_FN_POWER_SLEEP,4,x) // Poll All Key + Ext. Power plug-in (ECR17-0029)
#define os_power_sleep_awake_wto(x)     (int)sys_func2(OS_FN_POWER_SLEEP,0,x) // Poll All
...
#define K_XHdImageSensor         0x60
  #define K_XHdNoImageSensor          0x00
//  #define K_XHdImageSensorInstalled   0x20
  #define K_XHdAFImageSensorInstalled 0x20
  #define K_XHdFFImageSensorInstalled 0x40
...
typedef struct {
  BYTE b_gps_mode;            /* "a" */
  BYTE b_gps_fix_type;        /* "x", 1 = Fix not available; 2 = 2D; 3 = 3D */
  WORD b_gps_sat_ID[13];      /* "xx" */
}T_GPS_GSA_INFO;

typedef struct {
  BYTE msg_num_ttl;       /* Total number of GSV message to be transmitted, 1-3 */
  BYTE seq_num_curr;      /* sequence number of current GSV message */
  BYTE b_gps_sat_in_view;     /* "xx", 0~12 */
  WORD b_gps_sat_ID[13];      /* "uu" */
  WORD b_gps_sat_ID_SNR[13];  /* "ss", 0~99 */
}T_GPS_GSV_INFO;
...
//DWORD os_gps_get_detail_info(T_GPS_INFO *a_gps_info, T_GPS_GSA_INFO *a_gps_gsa_info, T_GPS_GSA_INFO *a_gps_gsv_info)
#define os_gps_get_detail_info(x,y,z)       sys_func3(OS_FN_GPS_GET_DETAIL_INFO, (DWORD)(x),(DWORD)(y),(DWORD)(z))
...
enum{
  ...
  SENSOR_MODE_640,
  SENSOR_MODE_960,
  SENSOR_MODE_FULL_SCREEN = 0x8000
};
...
// int os_image_sensor_set_mode(DWORD mode, T_LCDG* preview_cfg, T_IMAGE_FRAME* cfg);
#define os_image_sensor_set_mode(x,y,z)     (int)sys_func3(OS_FN_IMG_SENSOR_SET_MODE, (DWORD)(x), (DWORD)(y), (DWORD)(z))
