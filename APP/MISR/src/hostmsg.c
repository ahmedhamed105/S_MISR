...
//    get_mem(&RSP_DATA.s_dtg.b_hour, 12);
  ...
  if (bitmap[2] & 0x04) {
       memset(field, 0, sizeof(field));
      print_field(&field,field,12,22);
   // inc_pptr(12);
  }
   /* 23. Pan Sequence Number */
  if (bitmap[2] & 0x02) {
       memset(field, 0, sizeof(field));
      print_field(&field,field,3,23);
   // inc_pptr(3);
  }
  /* 24. bypass netword id */
  if (bitmap[2] & 0x01) {
       memset(field, 0, sizeof(field));
      print_field(&field,field,3,24);
   // inc_pptr(3);
  }
  ...
  if (bitmap[3] & 0x01) {
      ...
      var_i = bcd2bin(get_byte());
      memset(RSP_DATA.sb_pan, 0xFF, 10);
      print_field(&field,field,var_i,32);
   // inc_pptr(6);
  }
    ...
    if (bitmap[4] & 0x40) {
        ...
        var_i = bcd2bin(get_byte());
        memset(RSP_DATA.sb_pan, 0xFF, 10);
        print_field(&field,field,var_i,34);
        // inc_pptr(6);
    }
  ...
  if (bitmap[4] & 0x20) {
      ...
      var_i = bcd2bin(get_byte());
      memset(RSP_DATA.sb_pan, 0xFF, 10);
      print_field(&field,field,var_i,35);
  }
 ...
 /* 42.Card acceptor identification */
  ...
  if (bitmap[5] & 0x20) {
      ...
      var_i = bcd2bin(get_byte());
      memset(RSP_DATA.sb_pan, 0xFF, 10);
      print_field(&field,field,var_i,43);
  }
    ...
    if (bitmap[5] & 0x10) {
        ...
        memset(RSP_DATA.sb_pan, 0xFF, 10);
        print_field(&field,field,var_i,44);
    }
  ...
  if (bitmap[5] & 0x01) {
      ...
      var_i = bcd2bin(get_word());
      memset(RSP_DATA.sb_pan, 0xFF, 10);
      print_field(&field,field,var_i,48);
  }

   /* 49.	Transaction currency code */
  if (bitmap[6] & 0x80) {
       memset(field, 0, sizeof(field));
          print_field(&field,field,3,49);
	// inc_pptr(3);
  }
  ...
  if (bitmap[6] & 0x08) {
      ...
      var_i = bcd2bin(get_byte());
      memset(RSP_DATA.sb_pan, 0xFF, 10);
      print_field(&field,field,var_i,53);
  }
  ...
  if (bitmap[6] & 0x04) {
      ...
      var_i = bcd2bin(get_word());
      memset(RSP_DATA.sb_pan, 0xFF, 10);
      print_field(&field,field,var_i,54);
  ...
  if (bitmap[6] & 0x02) {
      ...
      var_i = bcd2bin(get_word());
      memset(RSP_DATA.sb_pan, 0xFF, 10);
      print_field(&field,field,var_i,55);
 ...
 //     return(TRANS_FAIL);
  ...
  //  get_mem(RSP_DATA.s_icc_data.sb_misc_content, RSP_DATA.s_icc_data.w_misc_len);
    ...
    if (bitmap[6] & 0x02) {
        ...
        var_i = bcd2bin(get_byte());
        memset(RSP_DATA.sb_pan, 0xFF, 10);
        print_field(&field,field,var_i,56);
  ...
  if (bitmap[7] & 0x04) {
      ...
      var_i = bcd2bin(get_word());
      memset(RSP_DATA.sb_pan, 0xFF, 10);
      print_field(&field,field,var_i,62);
...
//    RSP_DATA.text[0] = (BYTE)((var_i > 69) ? 69 : var_i);
 //   get_mem(&RSP_DATA.text[1], RSP_DATA.text[0]);
      ...
      var_i = bcd2bin(get_word());
      memset(RSP_DATA.sb_pan, 0xFF, 10);
      print_field(&field,field,var_i,63);
